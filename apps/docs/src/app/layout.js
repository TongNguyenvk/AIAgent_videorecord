...
import "./globals.css";
const DESCRIPTION = "Record scripted browser demos as MP4 videos with sound effects, cursor animation, and keystroke overlays.";
...
function Header() {
    return (<header className="sticky top-0 z-50 bg-white/90 backdrop-blur-sm dark:bg-neutral-950/90">
      <div className="flex h-14 items-center justify-between px-4 gap-6">
        <div className="flex items-center gap-2">
          <Link href="https://vercel.com" aria-label="Vercel">
            <svg data-testid="geist-icon" height="18" strokeLinejoin="round" viewBox="0 0 16 16" width="18" style={{ color: "currentcolor" }} aria-hidden="true">
        ...
        <nav aria-label="External links" className="flex items-center gap-4">
          <a href="https://github.com/vercel-labs/webreel" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-sm text-neutral-500 hover:text-neutral-900 transition-colors dark:text-neutral-400 dark:hover:text-neutral-100">
          ...
          <a href="https://www.npmjs.com/package/webreel" target="_blank" rel="noopener noreferrer" className="text-sm text-neutral-500 hover:text-neutral-900 transition-colors dark:text-neutral-400 dark:hover:text-neutral-100">
            npm
          </a>
          <ThemeToggle />
        </nav>
