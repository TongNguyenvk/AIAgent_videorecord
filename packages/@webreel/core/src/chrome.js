...
export const HEADLESS_SHELL_CACHE_DIR = resolve(homedir(), ".webreel", "bin", "chrome-headless-shell");
...
export async function ensureHeadlessShell() {
    if (process.env.CHROME_HEADLESS_PATH)
        return process.env.CHROME_HEADLESS_PATH;
...
export async function launchChrome(options) {
    if (options?.cdpUrl) {
        ...
        return {
            process: null, // Not used when providing cdpUrl
            port,
            kill: () => {
