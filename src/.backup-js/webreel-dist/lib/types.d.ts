...
export type Step = StepPause | StepClick | StepKey | StepDrag | StepType | StepScroll | StepWait | StepMoveTo | StepScreenshot | StepNavigate | StepHover | StepSelect | StepInjectType;
