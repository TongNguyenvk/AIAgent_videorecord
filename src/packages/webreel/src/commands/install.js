...
import { ensureChrome, ensureHeadlessShell, ensureFfmpeg, CHROME_CACHE_DIR, HEADLESS_SHELL_CACHE_DIR, FFMPEG_CACHE_DIR, } from "@webreel/core";
const STEPS = [
    {
...
export const installCommand = new Command("install")
    ...
    const results = await Promise.all(pending.map(async (step) => {
        try {
