...
async def _generate_speech_async(
    ...
    for attempt in range(max_retries):
        try:
            # Recreate object per attempt to prevent stale websocket exceptions
            ...
            if attempt < max_retries - 1:
                ...
                print(f"  [TTS WARN] Edge TTS chunk failed: {e}. Retrying {attempt+1}/{max_retries} in {wait_time:.2f}s...")
